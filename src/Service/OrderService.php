...
class OrderService
{
    ...
    private function sendEmailSafely(Email $email): void
    {
        try {
            ...
            // Set a short timeout so SMTP never hangs the request
